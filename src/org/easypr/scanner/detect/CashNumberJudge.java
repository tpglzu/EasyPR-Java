 ...
 *
 */
public class CashNumberJudge {

    public CashNumberJudge() {
        loadModel();
    }
...
//		int ret = (int) svm.predict(features);
//
//        return (int) ret;
        return 1;
    }
     ...
     */
    private SVMCallback features = new CashFeatures();

    /**
     * 模型存储路径
     */
    private String path = MLUtil.getSVMModel();
}
